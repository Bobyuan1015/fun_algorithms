...
from ReinforcementLearning.tsp.tsp_solver1.base_agent import Agent
from ReinforcementLearning.tsp.tsp_solver1.memory import Memory
...
class DQNAgent(Agent):
    ...
    def build_model(self,states_size,actions_size):
        ...
        model.add(tf.keras.layers.Dense(24,input_dim = states_size,activation = "relu"))
        model.add(tf.keras.layers.Dense(24,activation = "relu"))
        model.add(tf.keras.layers.Dense(actions_size,activation = "linear"))
