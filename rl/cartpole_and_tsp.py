...
from rl.env.tsp_env_old import TSPEnv
from rl.tsp.a2c_agent import ActorCriticAgent
from rl.tsp.dqn_agent import DQNAgent
from rl.tsp.ppo_agent_functional import PPOAgent
...
def train_agent(agent, env, is_tsp=False):
    ...
    plot_average_running_rewards(rewards)
